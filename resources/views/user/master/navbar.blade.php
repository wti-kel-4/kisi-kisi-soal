...
<nav class="navbar navbar-expand-lg main-navbar">
  ...
  <ul class="navbar-nav navbar-right">
    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
      @if (file_exists(public_path(Auth::guard('user')->user()->url_photo))) <img alt="image" src="{{ asset(Auth::guard('user')->user()->url_photo) }}" class="rounded-circle mr-1"> @else <img alt="image" src="{{ public_path('assets/img/user.png') }}" class="rounded-circle mr-1"> @endif
